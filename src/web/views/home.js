...
export function renderHomePage() {
  return page('racegoal — Your run, your words', html`<div class="site-shell">
    <header class="site-header"><a class="brand" href="/"><img class="brand-mark" src="/app-icon.png" alt="">racegoal</a><nav><a href="#how-it-works">How it works</a><a class="nav-login" href="/login">Log in</a></nav></header>
    <main class="home">
      <section class="hero">

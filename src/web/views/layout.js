...
export const page = (title, body) => html`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#f8f4ed"><title>${title}</title><style>
...
</style></head><body>${raw(body)}</body></html>`;
